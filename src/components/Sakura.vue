<template>
    <div>
        <div id="jsi-cherry-container" class="container">
            <canvas id="sakura" ref="sakuraRef" width="400" height="400"></canvas>
        </div>
    </div>
</template>
...
class RENDERER {
    constructor(context, width, height) {
        this.INIT_CHERRY_BLOSSOM_COUNT = 50
        this.MAX_ADDING_INTERVAL = 10
...
class CHERRY_BLOSSOM {
    constructor(renderer, isRandom) {
        ...
        this.FAR_LIMIT = 600
        this.MAX_RIPPLE_COUNT = 100
        this.RIPPLE_RADIUS = 100
        this.SURFACE_RATE = 0.5
        this.SINK_OFFSET = 20
...
function initCanvas(canvas, width = 400, height = 400) {
...
onMounted(() => {
    ...
    const myRender = new RENDERER(ctx, size.width, size.height)
    myRender.init()
})
</script>
